...
<div id="logindiv">
  <form action="controleur_user" method="Get">
    Entrer le login : <input type="text" name="login"><br>
    Entrer le password : <input type="password" name="passwd"><br>
  ...
  <br>
  <form action="controleur_user?action=1" method="Post">
